...
public class Test {
	...
	public static void insertDepartment() {
		...
		Employee doctor = new Doctor("Asen", "Evtimov", true , "Lusk", "0831762168", "Consultant", depratment1);
		Employee administrator = new Administrator("Lillie", "Bordello", true, "Dublin", "0888888899", "Receptionist");
		
		LoginUser user = new LoginUser("super", "super", "superUser", null);
		//Doctor drEvtimov = new Doctor("Asen", "Evtimov", false, "Luske", "0831762168", "Consultant", depratment1);
		LoginUser drEvtimovLogin = new LoginUser("asen", "asen", "doctor", (Doctor)doctor);
		LoginUser lillieLogin = new LoginUser("admin", "admin", "administrator", (Administrator)administrator);
		...
		//Rooms in Belle Ward
		Room roomBelle1 = new Room(wardBelle, roomCostPublic);
		...
		//Beds in Aladin Ward
		//Public
		Bed BedRoomAladdin1 = new Bed(true, roomAladdin1);
		Bed BedRoomAladdin2 = new Bed(true, roomAladdin1);
		Bed BedRoomAladdin3 = new Bed(true, roomAladdin1);
		Bed BedRoomAladdin4 = new Bed(true, roomAladdin1);
		Bed BedRoomAladdin5 = new Bed(true, roomAladdin1);
		Bed BedRoomAladdin6 = new Bed(true, roomAladdin1);
		//Semi-private
		Bed BedRoomAladdin7 = new Bed(true, roomAladdin2);
		Bed BedRoomAladdin8 = new Bed(true, roomAladdin2);
		Bed BedRoomAladdin9 = new Bed(true, roomAladdin2);
		Bed BedRoomAladdin10 = new Bed(true, roomAladdin2);
		//Private
		Bed BedRoomAladdin11 = new Bed(true, roomAladdin3);
		Bed BedRoomAladdin12 = new Bed(true, roomAladdin4);
		Bed BedRoomAladdin13 = new Bed(true, roomAladdin5);
		Bed BedRoomAladdin14 = new Bed(true, roomAladdin6);
		...
		Patient patient = new Patient("Jhon", "Smith", null, true, "Dublin", "089843", "Someone");
		Visit visit = new Visit(true,null, null, null, BedRoomAurora13, (Doctor)doctor, patient);
		...
		try {
			...
			session.save(user);
			session.save(drEvtimovLogin);
			session.save(lillieLogin);
			
			//all wards
			session.save(wardBelle);
			session.save(wardSarabi);
			session.save(wardPocahontas);
			session.save(wardAladdin);
			session.save(wardDemetrius);
			session.save(wardRapunzel);
			session.save(wardHercules);
			session.save(wardAurora);
			
			session.save(roomCostPublic);
			session.save(roomCostSemiPrivate);
			session.save(roomCostPrivate);
			//all rooms
			session.save(roomBelle1);
